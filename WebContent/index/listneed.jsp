...
<body>
	<div class="container-fluid">
		...
		<a href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=tianbao">
		...
		<div class="row-fluid">
			...
			<div class="col-md-10 ">
				...
				<tr>
					<td>${item.id }</td>
					<td><a href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=search&id=${item.id }">${item.jiname }</a></td>
