...
<body style="background-color:#dceefc">
	...
	<hr>
	<center>
	<form action="${pageContext.request.contextPath}/admin/xuqiuServlet?method=zhengjishenehe&id=${zhengjibean.id }" method="post">
		...
		<a href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=shenhe&status=1"><button type="button" class="btn btn-primary">返回</button></a>
	</form>
	</center>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form
							action="${pageContext.request.contextPath}/admin/xuqiuServlet?method=zhengjituihui&id=${zhengjibean.id }"
							method="post">
