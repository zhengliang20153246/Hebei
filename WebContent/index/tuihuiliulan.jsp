		...
		<div class="row-fluid">
			...
			<div class="col-md-10 ">
				...
				<tr>
					...
					<td>
					<a href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=tuihuineeddelete&id=${item.id }&userid=${user.id}">
					<button type="button" class="btn btn-primary">删除</button></a></td>
					<td>
					<a href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=tuihuiliulandetail&id=${item.id }">
